...
Экран запуска 
<img width="360" alt="Первый запуск" src="Images/Images/Экран запуска.png">

Начальный экран
<img width="360" alt="Первый запуск" src="Images/Начальный экран.png">

Экран входа
<img width="360" alt="Добавление города" src="Images/Экран входа.png">

Экран регистрации
<img width="360" alt="Просмотр почасовой погоды" src="Images/Экран регистрации.png">

Экран поиска
<img width="360" alt="Добавление нового города" src="Images/Экран поиска.png">

Экран поиска по запросу
<img width="360" alt="Неправильное имя города" src="Images/Экран поиска по запросу.png">

Экран добавления картинки в избранное
<img width="360" alt="Неправильное имя города" src="Images/Экран добавления картинки в избранное.png">

Экран с избранными картинками
<img width="360" alt="Неправильное имя города" src="Images/Экран с избранными картинками.png">

Экран с удалением картинки из избранного
<img width="360" alt="Неправильное имя города" src="Images/Экран с удалением картинки из избранного.png">
